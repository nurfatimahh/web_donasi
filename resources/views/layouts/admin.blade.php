...
<div class="flex">
    ...
    <aside class="w-64 bg-emerald-600 text-white min-h-screen">
        ...
        <a href="/admin/program" class="block px-6 py-3 hover:bg-emerald-500">Program Donasi</a>
        <a href="#" class="block px-6 py-3 hover:bg-emerald-600">Kebutuhan Material</a>
        <a href="#" class="block px-6 py-3 hover:bg-emerald-600">Transaksi Donasi</a>
